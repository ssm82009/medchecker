...
export const en = {
  ...
  scanMedicationsFromImage: 'Scan Medications from Image',
  ...
  enterHealthCondition: 'Enter health conditions',
  
  // Interaction results
  interactionsFound: 'Interactions Found',
  noInteractionsFound: 'No Interactions Found',
  noInteractions: 'No interactions were detected between these medications.',
  ...
  logoSaved: 'Logo text saved successfully',
  error: 'Error',
