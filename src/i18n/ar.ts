...
export const ar = {
  ...
  // Disclaimer
  disclaimer: "هذه النتيجة تم استخراجها بمساعدة خوارزميات الذكاء الاصطناعي وهي مخصصة للأغراض التعليمية ولابد من استشارة الطبيب أو الصيدلي قبل استخدام أي دواء!",
